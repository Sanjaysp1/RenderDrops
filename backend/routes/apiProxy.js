...
import { API_CLIENT_MAP, extractParams } from '../utils/pattern.js';
import { getAccessToken, getRequestHeaders } from '../utils/auth.js';
import { GOOGLE_CLOUD_PROJECT, GOOGLE_CLOUD_LOCATION, PROXY_HEADER } from '../config/env.js';
